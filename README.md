...
This project is build in two sections. First section includes "Header" and the "Headline", second section includes "Works" and "About Me" page. The header section uncludes the logo, named "My Logo" and navbar, and background template, icons. The second section includes pictures and icons. All elements (background and icons, logo) were exported from Figma phototype.
